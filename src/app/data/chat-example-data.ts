...
export class ChatExampleData {
    static init(messagesService: MessagesService, threadsService: ThreadsService, usersService: UserService): void {
    ...
    static setupBots(messageService: MessagesService): void {
        messageService.messagesForThreadUser(tEcho, echo)
        ...
        messageService.messagesForThreadUser(tRev, rev)
        .forEach((message: Message): void => {
            messageService.addMessage(
                new Message({
                    author: rev,
        ...
        messageService.messagesForThreadUser(tWait,wait)
        .forEach((message: Message): void => {
